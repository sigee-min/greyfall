...
async function playOneShot(path, volume) {
    if (typeof window === 'undefined')
        return;
    const ctx = getContext();
    if (!ctx) {
...
async function loadAudioBuffer(ctx, path) {
...
function playWithHtmlAudio(path, volume) {
...
function getHtmlAudioPool(path) {
...
function createAndStoreAudio(path, pool) {
